...
def main(args):        
    ...
    # Load data. For this task the input to the model is a one-hot encoding of whether an image is of an even or odd number.
    # for Evaluation, half the digits are generated with and even one-hot input and the other half for an odd one-hot input.
    ...
    y_test = np.zeros((batch_size * (nm_elements_test // batch_size), 784)) # is not used/ is a place holder
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Training a MCPC model on the MNIST dataset with conditional labels.',
    ...
    param.lr_h = 0.021313374651918984
    param.momentum = 0.9
    param.h_var = 1
    param.gamma = 0.0
    param.lr_p = 0.002382425785433915
    param.decay_p = 0.01
    param.input_var = 0.6150953498010856
    param.activation = "l-relu"
