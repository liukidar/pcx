...
def main(run_info: stune.RunInfo, checkpoint_dir: Path | None = None, seed: int | None = None):
    best_loss = run_experiment(
        ...
        internal_state_dim=run_info["hp/internal_state_dim"],
        internal_state_channels=run_info["hp/internal_state_channels"],
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config", required=True, type=str, help="Configuration file"
    )
