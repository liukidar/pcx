...
def train_on_batch(x: jax.Array, y: jax.Array, *, model: LinearModel, optim_w: pxu.Optim):
    ...
    # Learning step
    with pxu.step(model):
        _, g = pxf.value_and_grad(pxu.M(pxnn.LayerParam).to([False, True]), has_aux=True)(loss)(x, y,  model=model)
...
if __name__ == "__main__":
    ...
    run_info={
        ...
        "hp/batch_size": 128,
        "hp/epochs": 25,
        "hp/optim/w/lr": 0.00027487989229471686,
        "hp/optim/w/wd": 0.0051207238497154115
    }
    best_acc, accs = main(run_info)
    print(best_acc)
